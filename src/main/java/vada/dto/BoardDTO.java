...
public class BoardDTO implements Serializable{
	...
	public String toString() {
		return "BoardBean [sellerid=" + sellerid + ", productnum=" + productnum + ", title=" + title + ", wdate="
				+ wdate + ", content=" + content + ", bcategorynum=" + bcategorynum + ", buyerid=" + buyerid
				+ ", soldoutdate=" + soldoutdate + ", review=" + review + ", reviewscore=" + reviewscore
